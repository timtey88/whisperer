...
pub fn get_issue_url(logs: String) -> String {
    ...
    format!("https://github.com/thewh1teagle/whisperer/issues/new?assignees=octocat&labels=bug&projects=&template=bug_report.yaml&title=App+reports+bug&logs={}", urlencoding::encode(&format!("{}\n\n{}", extra_info, &logs)))
}
